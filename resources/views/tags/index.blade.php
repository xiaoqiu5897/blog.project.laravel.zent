...
<div id="main" class="penci-layout-grid penci-main-sticky-sidebar" style="position: relative; overflow: visible; box-sizing: border-box; min-height: 1px;">
	<div class="theiaStickySidebar" style="padding-top: 0px; padding-bottom: 1px; position: static;">
		<div class="archive-box">
			<div class="title-bar">
				<span style="font-family: 'Tangerine';text-transform: none!important; font-size: 50px; font-weight: normal;">Tag: </span><h1 style="font-family: 'Tangerine'; font-size: 80px; color: black;font-weight: bolder;text-transform: none!important;">{{$tag->name}}</h1>
			</div>
		</div>
		<ul class="penci-wrapper-data penci-grid">
			@if(isset($posts_tag))
			@foreach($posts_tag as $post)
			<li class="grid-style">
